...
<?php endif; ?>
  ...
  <div class="container-wrap">
        ...
        <div id="content">
          ...
          <?php if (theme_get_setting('breadcrumbs', 'phoenix_responsive_theme')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
...
<div id="footer">
  ...
  <!-- Social Links -->
  <?php if (theme_get_setting('social_links', 'phoenix_responsive_theme')): ?>
    <div class="social-icons">
     <ul>
      <li><a class="rss" href="<?php print $front_page; ?>rss.xml"><i class="fa fa-rss"></i></a></li>
      <li><a class="fb" href="<?php echo theme_get_setting('facebook_profile_url', 'phoenix_responsive_theme'); ?>" target="_blank" rel="me"><i class="fa fa-facebook"></i></a></li>
  ...
  <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> <p class="credits">
    <div class="clear"></div>
    </div>
  </div>
